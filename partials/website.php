...
<article class="shadow-lg p-4 rounded mb-6">
    <header class="text-gray-600 flex flex-col pb-2 border-b border-gray-200">
        <div class="flex">
    ...
    <main class="flex flex-col">
        ...
        <?php $status = $url->isUp ? LBX_ALL_UP : LBX_ALL_DOWN; ?>
            <article class="flex relative py-1 hover:bg-gray-100" title="<?php echo $url->isUp ? 'This URL is up.' : 'This URL is down.' ?>">
                <div
